...
export default function Sidebar({ isCollapsed, onToggle, isAuthenticated }) {
  ...
  return (
    <aside 
      className={`fixed inset-y-0 left-0 z-99 flex h-full flex-col border-r border-slate-200/80 bg-white/90 backdrop-blur-xl shadow-[0_20px_60px_-20px_rgba(15,23,42,0.25)] transition-all duration-300 md:relative 
